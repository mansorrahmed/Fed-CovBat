...
pheno = pd.read_table('Baselines/ComBat/examples/data/bladder-pheno.txt', index_col=0)
dat = pd.read_table('Baselines/ComBat/examples/data/bladder-expr.txt', index_col=0)
